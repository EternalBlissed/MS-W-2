...
async function getHelpMenu({ client, guild, }) {
  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      "**About Me:**\n" +
        "A multipurpose discord bot which can serve all your needs such Economy, Music and More!\n\n" +
        `**Docs** [Here](https://ixcy.gitbook.io/ms-w/)\n` + // I'm a lazy fuck i should of set this up as a variable in config.js, well i tryed and got fucking undefined issues
